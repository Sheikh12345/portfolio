                    ...
                    children: [
                        ...
                        child: Stack(
                          children: [
                            ...
                            Container(
                              ...
                              constraints:
                                  BoxConstraints(maxHeight: 365, maxWidth: 365),
                              decoration: BoxDecoration(
                                shape: BoxShape.circle,
                                border: Border(
                                    top: BorderSide(
                      ...
                      InkWell(
                        child: Container(
                          ...
                          constraints:
                              BoxConstraints(maxWidth: 120, maxHeight: 35),
                          child: Text(
                            "Hello I'm",
                      ...
                      Container(
                          ...
                          constraints:
                              BoxConstraints(maxHeight: 80, maxWidth: 500),
                          child: Text(
                            "M. Kashif\n\n",
                            style: GoogleFonts.lalezar(
                                ...
                                fontSize:
                                    size.width > 428 ? 70 : size.width * 0.17),
                      ...
                      Container(
                          ...
                          child: Text("App Developer\n\n",
                              style: TextStyle(
                                ...
                                fontSize:
                                    size.width > 428 ? 35 : size.width * 0.08,
                              ),
                              textAlign: TextAlign.center)),
                              ...
                              child: Row(
                                children: [
                                  InkWell(
                                    child: Icon(
                                      Icons.email,
                                      color: inbox ? Colors.blue : Colors.white,
                                      size: size.width > 368
                                          ? 17
                                          : size.width * 0.06,
                                    ),
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    child: Icon(Icons.call,
                                        color:
                                            phone ? Colors.blue : Colors.white,
                                        size: size.width > 368
                                            ? 17
                                            : size.width * 0.06),
                                    onHover: (value) {
                                  ...
                                  InkWell(
                                      ...
                                      child: Icon(Icons.location_on,
                                          ...
                                          size: size.width > 368
                                              ? 17
                                              : size.width * 0.06)),
                                  Text("    Gulshan-Ravi, Lahore, Pakistan",
                                      style: TextStyle(
                                        color: Colors.white,
                                        fontWeight: FontWeight.w100,
                                        fontSize: size.width > 368
                          ...
                          Wrap(
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(color: Color(0xff1e1e25)),
                                child: Column(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          constraints: BoxConstraints(
                              maxWidth: size.width<1335?350:400,
                              maxHeight: 400
                          ),
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text("Professional Skills",style: GoogleFonts.cabin(
                                  fontWeight: FontWeight.w800,
                                  fontSize: size.width<1335?35:40,
                                  color: Colors.white
                              ),),
                              SizedBox(
                                height: 40,
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Column(
                                      children: [
                                        Container(
                                          width: size.width<1335?80:100,
                                          height: 100,
                                          child: CircularPercentIndicator(
                                            radius: size.width<1335?80:100.0,
                                            lineWidth: 7.0,
                                            percent: 0.90,
                                            animation: true,
